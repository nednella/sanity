...
export function Navbar() {
    return (
        <header className="fixed inset-x-0 z-50">
            <div className="max-w-8xl mx-auto border-b lg:border-none lg:px-4 lg:pt-4">
                <div
                    className="bg-background flex h-16 items-center justify-between px-4 shadow-md lg:grid
