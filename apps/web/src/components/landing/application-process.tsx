...
function StepCard({ step }: Readonly<StepCardProps>) {
  return (
    <div className="group flex gap-4">
      <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-primary font-bold text-primary-content transition-transform select-none group-hover:scale-110">
        {step.number}
      </div>
