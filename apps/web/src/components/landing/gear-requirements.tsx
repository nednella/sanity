    ...
    <Section className="pb-24">
      <Container className="text-center lg:max-w-5xl">
        ...
        <Muted className="mb-8 text-lg">
          we maintain a minimum gear requirement in line with the current best-in-slot items for all active clan
          members, so you should ensure you meet the following checklist before you consider applying
        </Muted>
...
function GearCard({ item }: Readonly<GearCardProps>) {
  ...
  return (
    <div className="group flex aspect-square max-w-64 items-center justify-center overflow-hidden rounded-2xl border p-3 shadow-md transition-all hover:scale-110 hover:shadow-xl lg:p-6">
