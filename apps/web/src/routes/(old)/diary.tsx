    ...
    <>
      ...
      <Section className="pb-24">
        <Container>
          ...
          >
            <P>
              The Sanity Achievement Diary simply exists as a means to provide players with some benchmarks to push
              their skills and game knowledge well beyond what the in-game{" "}
              <a
            ...
            <P>
              With our diary — unlike the in-game variant — we focus only on completion time of hand-selected PvM
              content, and we regularly update our benchmarks in line with power creep.
            </P>
            <P>
              We use the diary internally as a competitive challenge for our members, but this doesn't mean you have to
              be a member to benefit. Feel free to use our proposed times as a means to benchmark yourself!
            </P>
          </TextWithImage>
        </Container>
      </Section>
        ...
        <Container>
          ...
          >
            <div>
              ...
              <P>
                Team-based tasks <strong>must</strong> be completed with Sanity members <strong>only</strong>, and any
                PBs acquired before joining the clan will <strong>not</strong> count (this excludes solo tasks).
              </P>
              <P>
                You must have a screenshot of the PB for it to be acknowledged — either the board itself or the POH log.
                Chat commands such as <code className="rounded bg-base-content px-1 py-0.5 text-base-100">!pb</code> are
                explicitly ignored.
              </P>
              {/* TODO: example submission screenshot */}
              <P>
                PB submission screenshots <strong>must</strong> display your boss KC, all participating members, and
                obviously the completion time itself.
              </P>
              <P>
              ...
              <P>
                Trial members <strong>cannot</strong> claim clan points for diary tier completion until they become a
                full member.
              </P>
            </div>
            <div>
